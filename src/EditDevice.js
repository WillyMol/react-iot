                ...
                <>                           
                            <div className="w3-card-4">
                                ...
                                <form onSubmit={this.handleSubmit} className="w3-container">
                                    ...
                                    <input className="w3-input w3-border w3-sand" type="text" value={this.state.Ip} onChange={this.handleDescription}></input>
                                    </p>
                                    <p>
                                    <label className="w3-text-brown"><b>Description:</b></label>
                                    <input className="w3-input w3-border w3-sand" type="text" value={this.state.Description} onChange={this.handleIp}></input>
                                    </p>
